...
import { formatPrice, getDiscountPercentage, cn } from '@/utils';
  ...
  return (
    <div className={cn("group relative bg-white rounded-lg overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg", className)}>
      <Link to={`/product/${product.id}`} className="block">
        <div className="relative overflow-hidden">
          ...
          {product.inStock && (
            <button
              ...
              className="absolute bottom-4 left-4 right-4 bg-black text-white py-3 font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 hover:bg-orange-500"
            >
              Quick Add
            </button>
          )}
        ...
        <div className="p-4">
          <h3 className="font-bold text-black mb-1 group-hover:text-orange-500 transition-colors">
            {product.name}
          </h3>

...
// Completely disable all monitoring imports to fix crash
...
function App() {
  ...
  useEffect(() => {
    // Temporarily disable problematic initialization to fix app crash
    // TODO: Re-enable once debugging is complete
    const initializeServices = async () => {
      try {
        // Initialize services one by one with error handling
        console.log('🚀 CalistaLife app starting...');
        ...
        console.warn('Service initialization skipped due to error:', error?.message);
      }
    };

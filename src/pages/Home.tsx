                ...
                <div className="relative overflow-hidden rounded-lg mb-4">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = `https://via.placeholder.com/600x400?text=${encodeURIComponent(collection.name)}`;
                    }}
                  />
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    <Link
                      ...
                      className="block w-full bg-white text-black py-3 font-bold text-center uppercase tracking-wider hover:bg-orange-500 hover:text-white transition-all"
                    >
                      View Collection
                    </Link>
                  </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <Link
                  to="/about"
                  className="inline-block px-8 py-4 font-bold uppercase tracking-wider bg-black text-white hover:bg-orange-500 transition-all"
                >
                  Learn More About Us
                </Link>
              </div>
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start">
                      <span className="w-3 h-3 bg-orange-500 rounded-full mt-1.5 mr-4 flex-shrink-0"></span>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto">
              ...
              <button
                type="submit"
                className="px-8 py-4 font-bold uppercase tracking-wider bg-orange-500 text-white hover:bg-white hover:text-black transition-all"
              >
                Subscribe
              </button>
            </form>
